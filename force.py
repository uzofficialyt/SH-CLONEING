...
banr = ("""\033[1;92m   _____ __  _____    ____  __  _______   __
  / ___// / / /   |  / __ \/ / / /  _/ | / /
  \__ \/ /_/ / /| | / / / / /_/ // //  |/ / 
 ___/ / __  / ___ |/ /_/ / __  // // /|  /  
/____/_/ /_/_/  |_/_____/_/ /_/___/_/ |_/   
     \033[1;91m<═══\033[1;41m\033[1;97m Created by SHADHIN-ZX \033[;0m\033[1;91m═══>\033[1;92m""")
...
\033[1;97m➤ \033[1;92mTool BruteX is created by SHADHIN-ZX
\033[1;92m""")
...
# main script start
os.system("xdg-open https://www.facebook.com/groups/905861483986856/?ref=share")
time.sleep(1.5)
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://instagram.com/cartoon_x_editor?igshid=ZDdkNTZiNTM=")
            
			elif fol == '2' or fol == '02':
				print()
				print("\033[1;91m[*] \033[1;97mOpening my Facebook page in your device \n")
				time.sleep(1)
				os.system("xdg-open https://www.facebook.com/profile.php?id=100090724636254&mibextid=ZbWKwL")
